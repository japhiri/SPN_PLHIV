...
# FIGURE 1 ----
# Figure 1a
Fig1a <- magick::image_read("Final_Paper_Figures/Figure 1/Fig1a.png")
Fig1a <- ggdraw()+ 
...
Fig1b <- Masterfile %>%
  ...
  geom_pwc(method = 'wilcox.test',
           #label = "{paste0('p = ', signif(p, digits = 10))}", 
...
ggsave(Fig1b,filename="Final_Paper_Figures/Figure 1/Fig1b.png",
       width = 9,height = 10,dpi = 300)
ggsave(Fig1b,filename="Final_Paper_Figures/Figure 1/Fig1b.pdf",
       width = 9,height = 10,dpi = 300)
``````
# Figure 1c
...
ggsave(Fig1c,filename="Final_Paper_Figures/Figure 1/Fig1c.png",
       width = 8,height = 10,dpi = 300)
ggsave(Fig1c,filename="Final_Paper_Figures/Figure 1/Fig1c.pdf",
       width = 8,height = 10,dpi = 300)
``````
# Figure 1d
...
ggsave(Fig1d,filename="Final_Paper_Figures/Figure 1/Fig1d.png",
       width = 8,height = 9,dpi = 300)
ggsave(Fig1d,filename="Final_Paper_Figures/Figure 1/Fig1d.pdf",
       width = 8,height = 9,dpi = 300)
...
ggsave(Fig1e,filename="Final_Paper_Figures/Figure 1/Fig1e.png",
       width = 8,height = 9,dpi = 300)
ggsave(Fig1e,filename="Final_Paper_Figures/Figure 1/Fig1e.pdf",
       width = 8,height = 9,dpi = 300)
````
# Figure 1f
...
ggsave(Fig1f,filename="Final_Paper_Figures/Figure 1/Fig1f.png",
       width = 8,height = 9,dpi = 300)
ggsave(Fig1f,filename="Final_Paper_Figures/Figure 1/Fig1f.pdf",
       width = 8,height = 9,dpi = 300)
````
...
Fig1g
ggsave(Fig1g,filename="Final_Paper_Figures/Figure 1/Fig1g.png",
       width = 8,height = 9,dpi = 300)
ggsave(Fig1g,filename="Final_Paper_Figures/Figure 1/Fig1g.pdf",
       width = 8,height = 9,dpi = 300)
````
# Figure 1h
...
Fig1h
ggsave(Fig1h,filename="Final_Paper_Figures/Figure 1/Fig1h.png",
       width = 8,height = 9,dpi = 300)
ggsave(Fig1h,filename="Final_Paper_Figures/Figure 1/Fig1h.pdf",
       width = 8,height = 9,dpi = 300)
````
# Figure 1i
...
ggsave(Fig1i,filename="Final_Paper_Figures/Figure 1/Fig1i.png",
       width = 8,height = 9,dpi = 300)
ggsave(Fig1i,filename="Final_Paper_Figures/Figure 1/Fig1i.pdf",
       width = 8,height = 9,dpi = 300)
````
# ggsave Final figure 1
ggsave(filename = "Final_Paper_Figures/Figure 1/Final_Fig1.pdf",
...
ggsave(filename = "Final_Paper_Figures/Figure 1/Final_Fig1.png",
       plot = ((Fig1a|Fig1b|plot_layout(ncol = 2,nrow = 1, width = c(3,1))))/ 
         (Fig1c|Fig1d|Fig1e|Fig1f|plot_layout(width = c(1,1,1,1)))/
         (Fig1g|Fig1h|Fig1i|plot_layout(width = c(1,1,1,1))),
       width = 32, height = 29, units = "in", dpi = 300)
...
Extended_Fig1c <- Masterfile %>%
  ...
  scale_color_manual(values = c('#A9A9A9','#941100','#005493'))+
  labs(x='',
       y=expression("Frequency of DN"^"-"~"T cells (%)"),
       fill='HIV Status'#,title = "c."
  )+
...
Extended_Fig1c
ggsave(Extended_Fig1c,filename="New_Figures/Extended_Figure 1/Extended_Fig1c.png",
       width = 8,height = 10,dpi = 300)
ggsave(Extended_Fig1c,filename="New_Figures/Extended_Figure 1/Extended_Fig1c.pdf",
       width = 8,height = 10,dpi = 300)
...
Extended_Fig1c <- magick::image_read("New_Figures/Extended_Figure 1/Extended_Fig1c.png")
Extended_Fig1c <- ggdraw()+ 
  draw_image(Extended_Fig1c, scale = 1.0)+
  labs(title = "c.")+
  theme(
    plot.title = element_text(hjust = 0.0,vjust = .01, size = 50, face = "bold"),  # Customize title
    plot.margin = unit(c(0,0,0,0), "cm")  # Optional: adjust margins
...
# Save Extended_Figure 1 ggsave
ggsave(filename = "New_Figures/Extended_Figure 1/Extended_Fig1.pdf",
       plot = ((Extended_Fig1a|plot_spacer()|plot_layout(ncol = 2,nrow = 1, width = c(2,0.001))))/
         (Extended_Fig1b|plot_layout(width = c(2,0.001)))/
         (Extended_Fig1d|plot_layout(width = c(1,1,1,1)))/
         (plot_spacer()|plot_layout(width = c(1))),  
       width = 32, height = 29, units = "in", dpi = 300)

ggsave(filename = "New_Figures/Extended_Figure 1/Extended_Fig1.png",
       plot = ((Extended_Fig1a|plot_spacer()|plot_layout(ncol = 2,nrow = 1, width = c(2,0.001))))/
         (Extended_Fig1b|plot_layout(width = c(2,0.001)))/
         (Extended_Fig1d|plot_layout(width = c(1,1,1,1)))/
         (plot_spacer()|plot_layout(width = c(1))),  
...
Extended_Fig2a <- Masterfile %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Extended_Fig2a
ggsave(Extended_Fig2a,filename="New_Figures/Reviewers_Comments/Extended_Figure 2/Extended_Fig2a.png",
...
Extended_Fig2b <- Cytokines %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Extended_Fig2b
ggsave(Extended_Fig2b,filename="New_Figures/Reviewers_Comments/Extended_Figure 2/Extended_Fig2b.png",
       width = 8,height = 12,dpi = 300)
````
# Figure 2c
...
Extended_Fig2c <- Cytokines %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Extended_Fig2c
ggsave(Extended_Fig2c,filename="New_Figures/Reviewers_Comments/Extended_Figure 2/Extended_Fig2c.png",
       width = 8,height = 12,dpi = 300)
````
# Figure 2d
...
Extended_Fig2d <- Cytokines %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Extended_Fig2d
ggsave(Extended_Fig2d,filename="New_Figures/Reviewers_Comments/Extended_Figure 2/Extended_Fig2d.png",
       width = 8,height = 12,dpi = 300)
...
Extended_Fig2e <- Cytokines %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Extended_Fig2e
ggsave(Extended_Fig2e,filename="New_Figures/Reviewers_Comments/Extended_Figure 2/Extended_Fig2e.png",
       width = 8,height = 12,dpi = 300)
````
# Figure 2f
...
Extended_Fig2f <- Cytokines %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Extended_Fig2f
ggsave(Extended_Fig2f,filename="New_Figures/Reviewers_Comments/Extended_Figure 2/Extended_Fig2f.png",
       width = 8,height = 12,dpi = 300)
````
# Figure 2g
...
Extended_Fig2g <- Cytokines %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Extended_Fig2g
ggsave(Extended_Fig2g,filename="New_Figures/Reviewers_Comments/Extended_Figure 2/Extended_Fig2g.png",
       width = 8,height = 12,dpi = 300)
````
# Figure 2h
...
Extended_Fig2h <- Cytokines %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Extended_Fig2h
ggsave(Extended_Fig2h,filename="New_Figures/Reviewers_Comments/Extended_Figure 2/Extended_Fig2h.png",
       width = 8,height = 12,dpi = 300)
````
# Figure 2i
...
Extended_Fig2i <- Cytokines %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Extended_Fig2i
ggsave(Extended_Fig2i,filename="New_Figures/Reviewers_Comments/Extended_Figure 2/Extended_Fig2i.png",
       width = 8,height = 12,dpi = 300)
````
# Figure 2j
...
Extended_Fig2j <- Cytokines %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Extended_Fig2j
ggsave(Extended_Fig2j,filename="New_Figures/Reviewers_Comments/Extended_Figure 2/Extended_Fig2j.png",
       width = 8,height = 12,dpi = 300)
````
# Figure 2k
...
Extended_Fig2k <- Cytokines %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Extended_Fig2k
ggsave(Extended_Fig2k,filename="New_Figures/Reviewers_Comments/Extended_Figure 2/Extended_Fig2k.png",
       width = 8,height = 12,dpi = 300)
````
# Save figure 2 ggsave
ggsave(filename = "New_Figures/Extended_Figure 2/Extended_Fig2.pdf",
...
ggsave(filename = "New_Figures/Reviewers_Comments/Extended_Figure 2/Extended_Fig2.png",
       plot = ((Extended_Fig2a|Extended_Fig2b|Extended_Fig2c|Extended_Fig2d|plot_layout(ncol = 4,nrow = 1, width = c(1,1,1,1))))/ 
         (Extended_Fig2e|Extended_Fig2f|Extended_Fig2g|Extended_Fig2h|plot_layout(width = c(1,1,1,1)))/
         (Extended_Fig2i|Extended_Fig2j|Extended_Fig2k|plot_layout(width = c(1,1,1,1))),
       width = 32, height = 29, units = "in", dpi = 300)
...
Fig3b
ggsave(Fig3b,filename="New_Figures/Figure 3/Fig3b.png",
       width = 8,height = 10,dpi = 300)
ggsave(Fig3b,filename="New_Figures/Figure 3/Fig3b.pdf",
       width = 8,height = 10,dpi = 300)
````

Fig3c_counts <- Masterfile %>%
...
Fig3c <- Masterfile %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title.y = element_text(size = 30))
Fig3c
ggsave(Fig3c,filename="New_Figures/Figure 3/Fig3c.png",
       width = 8,height = 10,dpi = 1080)
````
# Figure 3d
Fig3d <- Masterfile %>%
  filter(`Epithelial count`>100,
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Fig3d
ggsave(Fig3d,filename="New_Figures/Figure 3/Fig3d.png",
       width = 8,height = 10,dpi = 1080)
````
# Figure 3d
Fig3e <- Masterfile %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Fig3e
ggsave(Fig3e,filename="New_Figures/Figure 3/Fig3e.png",
       width = 8,height = 10,dpi = 1080)
````
# Saving Figure 3 using ggsave
Fig3a <- magick::image_read("New_Figures/Figure 3/Fig3a_new.png")
Fig3a <- ggdraw()+ 
  draw_image(Fig3a, scale = 1.2)+
  labs(title = "a.")+
  theme(
...
````
Fig3b <- magick::image_read("New_Figures/Figure 3/Fig3b.png")
Fig3b <- ggdraw()+ 
...
Fig4a <- as.ggplot(Fig4a)
Fig4a
# Save Figure 4a
ggsave(Fig4a,filename="New_Figures/Figure 4/Fig4a.png",
       width = 12,height = 9,dpi = 300,units = "in")
ggsave(Fig4a,filename="New_Figures/Figure 4/Fig4a.pdf",
       width = 12,height = 9,dpi = 300,units = "in")
````
# Figure 4b (Main Bargraph)
...
# Save Figure 4b
ggsave(Fig4b,filename="New_Figures/Figure 4/Fig4b.png",
       width = 10,height = 12,dpi = 300,units = "in")
ggsave(Fig4b,filename="New_Figures/Figure 4/Fig4b.pdf",
       width = 10,height = 12,dpi = 300,units = "in")
````


# Figure 4c (vlnPlot of celltype markers)
celltype_markers <- c(
...
Fig4c <- Seurat::VlnPlot(all_merged_subset_labelled_new,
...
# Save Figure 4c
ggsave(Fig4c,filename="New_Figures/Figure 4/Fig4c.png",
       width = 20,height = 6,dpi = 1080,units = "in")
ggsave(Fig4c,filename="New_Figures/Figure 4/Fig4c.pdf",
       width = 20,height = 6,dpi = 1080,units = "in")
````

# Figure 4d (Immune cells UMAP)
...
Fig4d
# Save Figure 3d
ggsave(Fig4d,filename="New_Figures/Figure 4/Fig4d.png",
       width = 8,height = 8,dpi = 1080,units = "in")
ggsave(Fig4d,filename="New_Figures/Figure 4/Fig4d.pdf",
       width = 8,height = 8,dpi = 1080,units = "in")
````
# Figure 4e (Immune cell proportion bargraph)
# Calculate cluster proportion 
HIV_status_colors <- c('#A9A9A9','#941100','#005493')
...
# Save Figure 3e
ggsave(Fig4e,filename="New_Figures/Figure 4/Fig4e.png",
       width = 10,height = 12,dpi = 300,units = "in")
ggsave(Fig4e,filename="New_Figures/Figure 4/Fig4e.pdf",
       width = 10,height = 12,dpi = 300,units = "in")
````

# Figure 4g (Neutrophil epithelial ratio from scRNA sequencing data)
cluster_df <- as.data.frame(table(all_merged_subset_labelled_new$Clusters,
...
Fig4f <- cluster_df %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Fig4f
ggsave(Fig4f,filename="New_Figures/Figure 4/Fig4f.png",
       width = 14,height = 18,dpi = 300)
ggsave(Fig4f,filename="New_Figures/Figure 4/Fig4f.pdf",
       width = 14,height = 18,dpi = 300)
````
...
Fig4g <- cluster_df %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Fig4g
ggsave(Fig4g,filename="New_Figures/Figure 4/Fig4g.png",
       width = 14,height = 18,dpi = 300)
ggsave(Fig4g,filename="New_Figures/Figure 4/Fig4g.pdf",
       width = 14,height = 18,dpi = 300)
````
# Save figure 4 in ggsave
Fig4a <- magick::image_read("New_Figures/Figure 4/Fig4a.png")
Fig4a <- ggdraw()+ 
  draw_image(Fig4a, scale = 1.3)+
  labs(title = "a.")+
  theme(
...
Fig4c <- magick::image_read("New_Figures/Figure 4/Fig4c.png")
Fig4c <- ggdraw()+ 
...
Fig4d <- magick::image_read("New_Figures/Figure 4/Fig4d.png")
Fig4d <- ggdraw()+ 
...
Fig4g <- magick::image_read("New_Figures/Figure 4/Fig4g.png")
Fig4g <- ggdraw()+ 
  draw_image(Fig4g, scale = 1)+
  labs(title = "g.")+
  theme(
    plot.title = element_text(hjust = 0.01,vjust = .01, size = 60, face = "bold"),  # Customize title
    plot.margin = unit(c(0,0,0,0), "cm")  # Optional: adjust margins
...
ggsave(filename = "New_Figures/Figure 4/Fig4_new.pdf",
       plot = ((Fig4a|Fig4b|plot_layout(ncol = 2,nrow = 1, width = c(1.5,0.9), heights = c(1.3,1))))/ 
         (Fig4c|plot_layout(width = c(1)))/
         (Fig4d|Fig4e|Fig4f|plot_layout(width = c(1,1,1))),
       width = 35, height = 37, units = "in", dpi = 300)

ggsave(filename = "New_Figures/Figure 4/Fig4_new.png",
       plot = ((Fig4a|Fig4b|plot_layout(ncol = 2,nrow = 1, width = c(1.5,0.9), heights = c(1.3,1))))/ 
         (Fig4c|plot_layout(width = c(1)))/
         (Fig4d|Fig4e|Fig4f|plot_layout(width = c(1,1,1)))/
         (Fig4g|plot_spacer()|plot_spacer()|plot_layout(width = c(1.3,1,1))),
       width = 32, height = 42, units = "in", dpi = 300)

ggsave(filename = "New_Figures/Figure 4/Fig4_new.png",
       plot = ((Fig4a|Fig4b|plot_layout(ncol = 2,nrow = 1, width = c(1.5,0.9), heights = c(1.3,1))))/ 
         (Fig4c|plot_layout(width = c(1)))/
         (Fig4d|Fig4e|Fig4f|plot_layout(width = c(1,1,1))),
       #(Fig4g|plot_spacer()|plot_spacer()|plot_layout(width = c(1,1,1))),
       width = 30, height = 37, units = "in", dpi = 300)
...
ggsave(Extended_Fig3a,filename="New_Figures/Extended_Figure 3/Extended_Fig3.png",
       width = 20,height = 6,dpi = 1080,units = "in")
ggsave(Extended_Fig3a,filename="New_Figures/Extended_Figure 3/Extended_Fig3.pdf",
       width = 20,height = 6,dpi = 1080,units = "in")

``````
# FIGURE 5 ----
# Figure 5a (Epithelial cells communicating with Neutrophils)
...
# Save Fig5a
ggsave(Neg,filename="New_Figures/Figure 5/Fig5a1.png",
       width = 5.5,height = 10,dpi = 1080)
ggsave(`3M`,filename="New_Figures/Figure 5/Fig5a2.png",
       width = 5.5,height = 10,dpi = 1080)
ggsave(`1Y`,filename="New_Figures/Figure 5/Fig5a3.png",
       width = 5.5,height = 10,dpi = 1080)
png("New_Figures/Figure 5/Fig5a4.png", width = 800, height = 800)
replayPlot(legend)
dev.off()

````
# Extended Figure 5a (Immune cells communicating with Neutrophils)
...
# Save Extended Fig5a
ggsave(Immune_Neg,filename="New_Figures/Extended_Figure 5/Extended_Fig5a1.png",
       width = 12,height = 17,dpi = 300)
ggsave(Immune_3m,filename="New_Figures/Extended_Figure 5/Extended_Fig5a2.png",
       width = 12,height = 17,dpi = 300)
ggsave(Immune_1y,filename="New_Figures/Extended_Figure 5/Extended_Fig5a3.png",
       width = 12,height = 17,dpi = 300)
png("New_Figures/Extended_Figure 5/Extended_Fig5a4.png", width = 200, height = 200, res = 700)
replayPlot(Immune_legend)
dev.off()

svg("New_Figures/Extended_Figure 5/Extended_Fig5a4.svg", width = 6, height = 6)
replayPlot(Immune_legend)
dev.off()
````
...
Fig5b1 <- all_merged_subset_labelled_new@meta.data %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Fig5b1
ggsave(Fig5b1,filename="New_Figures/Figure 5/Fig5b1.png",
       width = 8,height = 10,dpi = 300)
ggsave(Fig5b1,filename="New_Figures/Figure 5/Fig5b1.pdf",
       width = 8,height = 10,dpi = 300)
````
Fig5b2 <- all_merged_subset_labelled_new@meta.data %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Fig5b2
ggsave(Fig5b2,filename="New_Figures/Figure 5/Fig5b2.png",
       width = 8,height = 10,dpi = 300)
ggsave(Fig5b2,filename="New_Figures/Figure 5/Fig5b2.pdf",
       width = 8,height = 10,dpi = 300)
````
Fig5b3 <- all_merged_subset_labelled_new@meta.data %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Fig5b3
ggsave(Fig5b3,filename="New_Figures/Figure 5/Fig5b3.png",
       width = 8,height = 10,dpi = 300)
ggsave(Fig5b3,filename="New_Figures/Figure 5/Fig5b3.pdf",
       width = 8,height = 10,dpi = 300)
````
Fig5b4 <- all_merged_subset_labelled_new@meta.data %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Fig5b4
ggsave(Fig5b4,filename="New_Figures/Figure 5/Fig5b4.png",
       width = 8,height = 10,dpi = 300)
ggsave(Fig5b4,filename="New_Figures/Figure 5/Fig5b4.pdf",
       width = 8,height = 10,dpi = 300)
````
Fig5b5 <- all_merged_subset_labelled_new@meta.data %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Fig5b5
ggsave(Fig5b5,filename="New_Figures/Figure 5/Fig5b5.png",
       width = 8,height = 10,dpi = 300)
ggsave(Fig5b5,filename="New_Figures/Figure 5/Fig5b5.pdf",
       width = 8,height = 10,dpi = 300)
````
Fig5b6 <- all_merged_subset_labelled_new@meta.data %>%
  dplyr::filter(Clusters  %in% c('Neutrophils')
  ) %>%
  ggplot(aes(HIV_Status,Chemotaxis_Score1, fill=HIV_Status))+
  geom_violin(trim = T, scale = "width")+
  stat_summary(geom = "point",
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Fig5b6
ggsave(Fig5b6,filename="New_Figures/Figure 5/Fig5b6.png",
       width = 8,height = 10,dpi = 300)
ggsave(Fig5b6,filename="New_Figures/Figure 5/Fig5b6.pdf",
       width = 8,height = 10,dpi = 300)
````

# Save figure 5 ggsave
Fig5a_new <- magick::image_read("New_Figures/Figure 5/Fig5a_new.png")
Fig5a_new <- ggdraw()+ 
  draw_image(Fig5a_new, scale = 1.2)+
  labs(title = "a.")+
  theme(
    plot.title = element_text(hjust = 0.0, vjust = .01, size = 50, face = "bold"),  # Customize title
    plot.margin = unit(c(0,0,0,0), "cm")  # Optional: adjust margins
...
Fig5b1 <- magick::image_read("New_Figures/Figure 5/Fig5b1.png")
Fig5b1 <- ggdraw()+ 
  draw_image(Fig5b1, scale = 1)+
  labs(title = "b.")+
  theme(
...
Fig5b2 <- magick::image_read("New_Figures/Figure 5/Fig5b2.png")
Fig5b2 <- ggdraw()+ 
  draw_image(Fig5b2, scale = 1)+
  labs(title = "c.")+
  theme(
    plot.title = element_text(hjust = 0.05, vjust = .01, size = 50, face = "bold"),  # Customize title
    plot.margin = unit(c(0,0,0,0), "cm")  # Optional: adjust margins
...
Fig5b3 <- magick::image_read("New_Figures/Figure 5/Fig5b3.png")
Fig5b3 <- ggdraw()+ 
  draw_image(Fig5b3, scale = 1)+
  labs(title = "d.")+
  theme(
    plot.title = element_text(hjust = 0.05, vjust = .01, size = 50, face = "bold"),  # Customize title
    plot.margin = unit(c(0,0,0,0), "cm")  # Optional: adjust margins
...
Fig5b4 <- magick::image_read("New_Figures/Figure 5/Fig5b4.png")
Fig5b4 <- ggdraw()+ 
  draw_image(Fig5b4, scale = 1)+
  labs(title = "e.")+
  theme(
    plot.title = element_text(hjust = 0.05, vjust = .01, size = 50, face = "bold"),  # Customize title
    plot.margin = unit(c(0,0,0,0), "cm")  # Optional: adjust margins
...
Fig5b5 <- magick::image_read("New_Figures/Figure 5/Fig5b5.png")
Fig5b5 <- ggdraw()+ 
  draw_image(Fig5b5, scale = 1)+
  labs(title = "f.")+
  theme(
    plot.title = element_text(hjust = 0.05, vjust = .01, size = 50, face = "bold"),  # Customize title
    plot.margin = unit(c(0,0,0,0), "cm")  # Optional: adjust margins
...
ggsave(filename = "New_Figures/Figure 5/Fig5.pdf",
       plot = ((Fig5a_new|plot_spacer()|plot_layout(ncol = 2,nrow = 1, width = c(1,0.0001))))/ 
         (Fig5b1|Fig5b2|Fig5b3|Fig5b4|plot_layout(width = c(1,1,1,1)))/
         (Fig5b5|plot_layout(width = c(1,1,1,1))),
       width = 32, height = 29, units = "in", dpi = 300)

ggsave(filename = "New_Figures/Figure 5/Fig5.png",
       plot = ((Fig5a_new|plot_spacer()|plot_layout(ncol = 2,nrow = 1, width = c(1,0.0001),heights = c(1.5,1.5))))/ 
         (Fig5b1|Fig5b2|Fig5b3|Fig5b4|plot_layout(width = c(1,1,1,1)))/
         (Fig5b5|plot_layout(width = c(1,1,1,1))),
       width = 32, height = 29, units = "in", dpi = 300)
````
...
Fig6b_new <- seurat_mast_3mvsneg_de_Neutrophils %>%
...
# Save Figure 6b
ggsave(Fig6b_new,filename="New_Figures/Figure 6/Fig6b_new.png",
       width = 14,height = 18,dpi = 300)
ggsave(Fig6b_new,filename="New_Figures/Figure 6/Fig6b_new.pdf",
       width = 14,height = 18,dpi = 300)
...
Fig6a_new <-seurat_mast_1yvsneg_de_Neutrophils %>%
  ggplot(aes(avg_log2FC,-log10(p_val),color = Significance))+
  geom_point(size=2.5,alpha=.5)+
...
Fig6a_new
# Save Figure 6a2
ggsave(Fig6a_new,filename="New_Figures/Figure 6/Fig6a_new.png",
       width = 14,height = 18,dpi = 300)
ggsave(Fig6a_new,filename="New_Figures/Figure 6/Fig6a_new.pdf",
       width = 14,height = 18,dpi = 300)
````
...
Fig6c_new <- seurat_mast_3mvs1y_de_Neutrophils %>%
  ggplot(aes(avg_log2FC,-log10(p_val),color = Significance))+
  geom_point(size=2.5,alpha=.5)+
  geom_text_repel(aes(label = label),size=8)+
  geom_hline(yintercept = 1.3,linetype='dashed')+
...
Fig6c_new
# Save Figure 6c
ggsave(Fig6c_new,filename="New_Figures/Figure 6/Fig6c_new.png",
       width = 14,height = 18,dpi = 300,units = "in")
ggsave(Fig6c_new,filename="New_Figures/Figure 6/Fig6c_new.pdf",
       width = 14,height = 18,dpi = 300,units = "in")
...
Fig6d_new <- Neutrophil_enrichment %>%
...
Fig6d_new
ggsave(Fig6d_new,filename="New_Figures/Figure 6/Fig6d_new.png",
       width = 4,height = 5, dpi = 1080,units = "in")
ggsave(Fig6d_new,filename="New_Figures/Figure 6/Fig6d_new.pdf",
       width = 4,height = 5, dpi = 1080,units = "in")
...
Fig6e_new
ggsave(Fig6e_new,filename="New_Figures/Figure 6/Fig6e_new.png",
       width = 15,height = 10,dpi = 300,units = "in")
ggsave(Fig6e_new,filename="New_Figures/Figure 6/Fig6e_new.pdf",
       width = 5.5,height = 4.5,dpi = 1080,units = "in")
````
...
ggsave(Fig6f_new,filename="New_Figures/Figure 6/Fig6f_new.png",
       width = 15,height = 10,dpi = 300,units = "in")
ggsave(Fig6f_new,filename="New_Figures/Figure 6/Fig6f_new.pdf",
       width = 5.5,height = 4.5,dpi = 1080,units = "in")
````
...
````
Fig6g_new <- Immune_cells@meta.data %>%
...
Fig6g_new
ggsave(Fig6g_new,filename="New_Figures/Figure 6/Fig6g_new.png",
       width = 5,height = 9,dpi = 1080)
ggsave(Fig6g_new,filename="New_Figures/Figure 6/Fig6g_new.pdf",
       width = 5,height = 9,dpi = 1080)
````
Fig6h_new <- Immune_cells@meta.data %>%
  dplyr::filter(Clusters=="Neutrophils",
                IFN_signalling4>0) %>%
...
Fig6h_new
ggsave(Fig6h_new,filename="New_Figures/Figure 6/Fig6h_new.png",
       width = 5,height = 9,dpi = 1080)
ggsave(Fig6h_new,filename="New_Figures/Figure 6/Fig6h_new.pdf",
       width = 5,height = 9,dpi = 1080)
````

Fig6i_new <- Immune_cells@meta.data %>%
  dplyr::filter(Clusters=="Neutrophils",
...
Fig6i_new
ggsave(Fig6i_new,filename="New_Figures/Figure 6/Fig6i_new.png",
       width = 5,height = 9,dpi = 1080)
ggsave(Fig6i_new,filename="New_Figures/Figure 6/Fig6i_new.pdf",
       width = 5,height = 9,dpi = 1080)
````

# Figure 6d
Fig6j_new <- Immune_cells@meta.data %>%
  dplyr::filter(Clusters=="Neutrophils",
                SASP2>0) %>%
...
Fig6j_new
ggsave(Fig6j_new,filename="New_Figures/Figure 6/Fig6j_new.png",
       width = 5,height = 9,dpi = 1080)
ggsave(Fig6j_new,filename="New_Figures/Figure 6/Fig6j_new.pdf",
       width = 5,height = 9,dpi = 1080)
````

# Antimicrobial function genes
Phagocytosis_pathogen_recognition <- c(#"FCGR3B",
  #"ITGAM",
  #"ITGB2"#,
  #"CYBA",
  #"CYBB",
...
Degranulation_antimicrobial_peptides <- c("MPO","ELANE","PRTN3","AZU1","LTF","DEFA1","CAMP")
Oxidative_burst <- c("CYBB","CYBA","NCF1","NCF2","NCF4","SOD2")
Cytokines_chemokines <- c("CXCL8","CSF3","CXCR1","CXCR2","TNF","IL1B")
NETosis <- c("PADI4","MPO","ELANE","HIST1H3A")
SASP <- c("CXCL8","FOS","H3F3A","STAT3","CEBPB","KDM6B","SOD2")

Neutrophils <- AddModuleScore(
  object = Neutrophils,
  features = list(c(Phagocytosis_pathogen_recognition)),
  name = "Phagocytosis_pathogen_recognition",
  slot = "data") 

Neutrophils <- AddModuleScore(
  object = Neutrophils,
  features = list(c(Degranulation_antimicrobial_peptides)),
  name = "Degranulation_antimicrobial_peptides",
  slot = "data") 

Neutrophils <- AddModuleScore(
  object = Neutrophils,
  features = list(c(Oxidative_burst)),
  name = "Oxidative_burst",
  slot = "data") 

Neutrophils <- AddModuleScore(
  object = Neutrophils,
  features = list(c(Cytokines_chemokines)),
  name = "Cytokines_chemokines",
  slot = "data") 

Neutrophils <- AddModuleScore(
  object = Neutrophils,
  features = list(c(SASP)),
  name = "SASP",
  slot = "data") 

Neutrophils <- AddModuleScore(
  object = Neutrophils,
  features = list(c(NETosis)),
  name = "NETosis",
  slot = "data") 
...
# MFI of Phagocytosis
Fig6k_counts <- Phagocytosis_data %>%
...
ggsave(Fig6k_new,filename="New_Figures/Figure 6/Fig6k_new.png",
       width = 14,height = 18,dpi = 300)

````
# MFI of Oxidation
Fig6l_counts <- Phagocytosis_data %>%
  dplyr::filter(Time=="45min",
                #Visit=="Week 1",
                Stimulant=="LPS") %>%
  dplyr::mutate(Oxidation_SI = (`MFI+`-`MFI-`)/(2*`rSD-`)) %>%
...
ggsave(Fig6l_new,filename="New_Figures/Figure 6/Fig6l_new.png",
       width = 14,height = 18,dpi = 300)
...
ggsave(filename = "New_Figures/Figure 6/Fig6_new.png",
       plot = ((Fig6a_new|Fig6b_new|Fig6c_new|plot_layout(ncol = 3,nrow = 1, width = c(1,1,1))))/ 
         (Fig6d_new|Fig6e_new|Fig6f_new|plot_layout(width = c(0.8,1,1)))/
         (Fig6g_new|Fig6h_new|Fig6i_new|Fig6j_new|plot_layout(width = c(1,1,1,1)))/
         (Fig6k_new|Fig6l_new|plot_spacer()|plot_layout(width = c(1,1,1,1))),
       width = 42, height = 50, units = "in", dpi = 300,limitsize = F)
ggsave(filename = "New_Figures/Figure 6/Fig6_new.pdf",
       plot = ((Fig6a_new|Fig6b_new|Fig6c_new|plot_layout(ncol = 3,nrow = 1, width = c(1,1,1))))/ 
         (Fig6d_new|Fig6e_new|Fig6f_new|plot_layout(width = c(0.8,1,1)))/
         (Fig6g_new|Fig6h_new|Fig6i_new|Fig6j_new|plot_layout(width = c(1,1,1,1)))/
         (Fig6k_new|Fig6l_new|plot_spacer()|plot_layout(width = c(1,1,1,1))),
...
ggsave(filename = "New_Figures/Reviewers_Comments/Figure 6/Fig6_new.pdf",
       plot = ((Fig6a_new|Fig6b_new|Fig6c_new|plot_layout(ncol = 3,nrow = 1, width = c(1,1,1))))/ 
         (Fig6d_new|Fig6e_new|Fig6f_new|plot_layout(width = c(0.8,1,1)))/
         (Fig6g_new|Fig6h_new|Fig6i_new|Fig6j_new|plot_layout(width = c(1,1,1,1)))/
         (Fig6k_new|Fig6l_new|plot_spacer()|plot_layout(width = c(1,1,1,1))),
...
# EXTENDED FIGURE 6 ----
# Save figure 6 ggsave
Extended_Fig6a <- Neutrophil_cem@ora %>%
...
ggsave(Extended_Fig6a,filename="New_Figures/Extended_Figure 6/Extended_Fig6a.png",
       width = 12,height = 15,dpi = 1080,units = "in")
ggsave(Extended_Fig6a,filename="New_Figures/Extended_Figure 6/Extended_Fig6a.pdf",
       width = 12,height = 15,dpi = 1080,units = "in")
````

Extended_Fig6b <- Neutrophil_cem@ora %>%
...
Extended_Fig6b
# Save Figure 6b
ggsave(Extended_Fig6b,filename="New_Figures/Extended_Figure 6/Extended_Fig6b.png",
       width = 12,height = 15,dpi = 1080,units = "in")
ggsave(Extended_Fig6b,filename="New_Figures/Extended_Figure 6/Extended_Fig6b.pdf",
       width = 12,height = 15,dpi = 1080,units = "in")
````

Extended_Fig6c <- Seurat::DotPlot(
  Immune_cells,
  idents = "Neutrophils",
  dot.min = 0,
  dot.scale = 10,
...
ggsave(Extended_Fig6c,filename="New_Figures/Extended_Figure 6/Extended_Fig6c.png",
       width = 14,height = 14,dpi = 1080,units = "in")
ggsave(Extended_Fig6c,filename="New_Figures/Extended_Figure 6/Extended_Fig6c.pdf",
       width = 14,height = 14,dpi = 1080,units = "in")
````
# Save extended figure 6 ggsave
ggsave(filename = "New_Figures/Extended_Figure 6/Extended_Fig6.png",
       plot = ((Extended_Fig6a|Extended_Fig6b|Extended_Fig6c|plot_layout(ncol = 3,nrow = 1, width = c(1,1,1))))/
         (plot_spacer()|plot_layout(width = c(3)))/
         (plot_spacer()|plot_layout(width = c(3))),
       width = 32, height = 29, units = "in", dpi = 300,limitsize = F)

ggsave(filename = "New_Figures/Extended_Figure 6/Extended_Fig6.pdf",
       plot = ((Extended_Fig6a|Extended_Fig6b|Extended_Fig6c|plot_layout(ncol = 3,nrow = 1, width = c(1,1,1))))/
         (plot_spacer()|plot_layout(width = c(3)))/
         (plot_spacer()|plot_layout(width = c(3))),
       width = 32, height = 29, units = "in", dpi = 300,limitsize = F)
...
write.csv(Sig_Tcell_3m_vs_Neg,'Results/Sig_Tcell_3m_vs_Neg.csv', row.names = T)
````
Sig_Tcell_3m_vs_Neg <- read_csv('Results/Sig_Tcell_3m_vs_Neg.csv')
rownames(Sig_Tcell_3m_vs_Neg) <- Sig_Tcell_3m_vs_Neg[[1]] 

Fig7b_new <- Sig_Tcell_3m_vs_Neg %>%
  as.data.frame() %>%
...
# Save Figure 7b
ggsave(Fig7b_new,filename="New_Figures/Figure 7/Fig7b_new.png",
       width = 14,height = 18,dpi = 300)
ggsave(Fig7b_new,filename="New_Figures/Figure 7/Fig7b_new.pdf",
       width = 14,height = 18,dpi = 300)
...
````
write.csv(Sig_Tcell_1y_vs_Neg,'Results/Sig_Tcell_1y_vs_Neg.csv',row.names = F)
````
Sig_Tcell_1y_vs_Neg <- read.csv('Results/Sig_Tcell_1y_vs_Neg.csv')

Fig7a_new <- Sig_Tcell_1y_vs_Neg %>%
  as.data.frame() %>%
  dplyr::mutate(Significance = ifelse(p>-log10(0.05) & logFC>.25, "Upregulated",
                                      ifelse(p>-log10(0.05) & logFC< -.25,"Downregulated","Not significant"))) %>%
  dplyr::mutate(label = ifelse(p>-log10(0.05) & abs(logFC)>.25,rownames(.),NA)) %>%
...
# Save Figure 7b
ggsave(Fig7a_new,filename="New_Figures/Figure 7/Fig7a_new.png",
       width = 14,height = 18,dpi = 300)
ggsave(Fig7a_new,filename="New_Figures/Figure 7/Fig7a_new.pdf",
       width = 14,height = 18,dpi = 300)
...
Tcell_3m_vs_1y
Sig_Tcell_3m_vs_1y <- Tcell_3m_vs_1y$data
````

write.csv(Sig_Tcell_3m_vs_1y,'Results/Sig_Tcell_3m_vs_1y.csv',row.names = F)
````
Sig_Tcell_3m_vs_1y <- read.csv('Results/Sig_Tcell_3m_vs_1y.csv')

Fig7c_new <- Sig_Tcell_3m_vs_1y %>%
  as.data.frame() %>%
  dplyr::mutate(Significance = ifelse(p>-log10(0.05) & logFC>.25, "Upregulated",
                                      ifelse(p>-log10(0.05) & logFC< -.25,"Downregulated","Not significant"))) %>%
  dplyr::mutate(label = ifelse(p>-log10(0.05) & abs(logFC)>.25,rownames(.),NA)) %>%
...
# Save Figure 7a
ggsave(Fig7c_new,filename="New_Figures/Figure 7/Fig7c_new.png",
       width = 14,height = 18,dpi = 300)
ggsave(Fig7c_new,filename="New_Figures/Figure 7/Fig7c_new.pdf",
       width = 14,height = 18,dpi = 300)
...
Fig7d_new <- Tcell_enrichment %>%
  ...
  guides(
    ...
    size = guide_legend(
      ...
      override.aes = list(size = c(15,25,40))))
Fig7d_new
ggsave(Fig7d_new,filename="New_Figures/Figure 7/Fig7d_new.png",
       width = 12,height = 14, dpi = 300,units = "in")
ggsave(Fig7d_new,filename="New_Figures/Figure 7/Fig7d_new.pdf",
       width = 12,height = 14, dpi = 300,units = "in")
`````
Tcell_cem@ora$ID <- str_wrap(Tcell_cem@ora$ID, width = 50)
Fig7e_new <- Tcell_cem@ora %>%
  dplyr::filter(Module=="M1",
                p.adjust<0.05,
  ...
  geom_vline(xintercept = -log10(0.05), linetype='dashed')
Fig7e_new
ggsave(Fig7e_new,filename="New_Figures/Figure 7/Fig7e_new.png",
       width = 14,height = 15,dpi = 300,units = "in")
ggsave(Fig7e_new,filename="New_Figures/Figure 7/Fig7e_new.pdf",
       width = 14,height = 15,dpi = 300,units = "in")
````
Tcell_cem@ora$ID <- str_wrap(Tcell_cem@ora$ID, width = 50)
Fig7f_new <- Tcell_cem@ora %>%
  dplyr::filter(Module=="M2",
                p.adjust<0.05,
  ...
  geom_vline(xintercept = -log10(0.05), linetype='dashed')
Fig7f_new
ggsave(Fig7f_new,filename="New_Figures/Figure 7/Fig7f_new.png",
       width = 15,height = 15,dpi = 300,units = "in")
ggsave(Fig7f_new,filename="New_Figures/Figure 7/Fig7f_new.pdf",
       width = 15,height = 15,dpi = 300,units = "in")
````
# Figure 7g
...
Fig7g_new
ggsave(Fig7g_new,filename="New_Figures/Figure 7/Fig7g_new.png",
       width = 9,height = 12,dpi = 300)
ggsave(Fig7g_new,filename="New_Figures/Figure 7/Fig7g_new.pdf",
       width = 9,height = 12,dpi = 300)
````

Fig7h_new <- Tcells@meta.data %>%
...
Fig7h_new
ggsave(Fig7h_new,filename="New_Figures/Figure 7/Fig7h_new.png",
       width = 9,height = 12,dpi = 300)
ggsave(Fig7h_new,filename="New_Figures/Figure 7/Fig7h_new.pdf",
       width = 9,height = 12,dpi = 300)
````
Fig7i_new <- Tcells@meta.data %>%
...
Fig7i_new
ggsave(Fig7i_new,filename="New_Figures/Figure 7/Fig7i_new.png",
       width = 9,height = 12,dpi = 300)
ggsave(Fig7i_new,filename="New_Figures/Figure 7/Fig7i_new.pdf",
       width = 9,height = 12,dpi = 300)
````
Fig7j_new <- Tcells@meta.data %>%
...
Fig7j_new
ggsave(Fig7j_new,filename="New_Figures/Figure 7/Fig7j_new.png",
       width = 9,height = 12,dpi = 300)
ggsave(Fig7j_new,filename="New_Figures/Figure 7/Fig7j_new.pdf",
       width = 9,height = 12,dpi = 300)
````

# Save figure 7 ggsave
ggsave(filename = "New_Figures/Reviewers_Comments/Figure 7/Fig7_new.png",
       plot =((Fig7a_new|Fig7b_new|Fig7c_new|plot_layout(ncol = 3,nrow = 1, width = c(1,1,1))))/ 
         (Fig7d_new|Fig7e_new|Fig7f_new|plot_layout(width = c(0.8,1,1)))/
         (Fig7g_new|Fig7h_new|Fig7i_new|Fig7j_new|plot_layout(width = c(1,1,1,1)))/
         (plot_spacer()|plot_layout(width = c(4))),
       width = 42, height = 50, units = "in", dpi = 300,limitsize = F)

ggsave(filename = "New_Figures/Reviewers_Comments/Figure 7/Fig7_new.pdf",
       plot =((Fig7a_new|Fig7b_new|Fig7c_new|plot_layout(ncol = 3,nrow = 1, width = c(1,1,1))))/ 
         (Fig7d_new|Fig7e_new|Fig7f_new|plot_layout(width = c(0.8,1,1)))/
         (Fig7g_new|Fig7h_new|Fig7i_new|Fig7j_new|plot_layout(width = c(1,1,1,1)))/
         (plot_spacer()|plot_layout(width = c(4))),
...
ggsave(Extended_Fig7a,filename="New_Figures/Extended_Figure 7/Extended_Fig7a.png",
       width = 12,height = 15,dpi = 300,units = "in")
ggsave(Extended_Fig7a,filename="New_Figures/Extended_Figure 7/Extended_Fig7a.pdf",
       width = 12,height = 15,dpi = 300,units = "in")
````

Extended_Fig7b <- Tcell_cem@ora %>%
  dplyr::filter(Module=="M2") %>%
  dplyr::mutate(Significance=ifelse(p.adjust<.05 & FoldEnrichment>0,"Upregulated",
                                    ifelse(p.adjust<.05 & FoldEnrichment<0,"Downregulated","Not significant")),
                label = ifelse(Significance=="Upregulated",Description,NA)) %>%
...
Extended_Fig7b
# Save Figure 6b
ggsave(Extended_Fig7b,filename="New_Figures/Extended_Figure 7/Extended_Fig7b.png",
       width = 12,height = 15,dpi = 300,units = "in")
ggsave(Extended_Fig7b,filename="New_Figures/Extended_Figure 7/Extended_Fig7b.pdf",
       width = 12,height = 15,dpi = 300,units = "in")
````
# Save Extended Figure 7
ggsave(filename = "New_Figures/Extended_Figure 7/Extended_Fig7.png",
       plot = ((Extended_Fig7a|Extended_Fig7b|plot_layout(ncol = 3,nrow = 1, width = c(1,1,1))))/
         (plot_spacer()|plot_layout(width = c(3)))/
         (plot_spacer()|plot_layout(width = c(3))),
       width = 32, height = 29, units = "in", dpi = 300,limitsize = F)

ggsave(filename = "New_Figures/Extended_Figure 7/Extended_Fig7.pdf",
       plot = ((Extended_Fig7a|Extended_Fig7b|plot_layout(ncol = 3,nrow = 1, width = c(1,1,1))))/
         (plot_spacer()|plot_layout(width = c(3)))/
         (plot_spacer()|plot_layout(width = c(3))),
       width = 32, height = 29, units = "in", dpi = 300,limitsize = F)
...
Fig8a_new <- Masterfile %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Fig8a_new
ggsave(Fig8a_new,filename="New_Figures/Figure 8/Fig8a_new.png",
       width = 15,height = 8,dpi = 300,units = "in")  
````
Fig8b_new_counts <- Masterfile %>%
  filter(`Epithelial count`>250,
         `CD45+ count`>500,
         `HIV Status`!="NA",
         `Visit` %in% c(#"Week 1"#,
...
Fig8d_new <- Masterfile %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Fig8d_new
ggsave(Fig8d_new,filename="New_Figures/Figure 8/Fig8d_new.png",
       width = 18,height = 15,dpi = 300)

````
Phagocytosis_data <- read_csv("Data/Main_Files_Thesis/Neutrophil_Phagocytosis.csv")
Fig8e_new_counts <- Phagocytosis_data %>%
  dplyr::filter(Time=="45min",
                #Visit=="Week 1",
                Stimulant=="LPS") %>%
  dplyr::mutate(Oxidation_SI = (`MFI+`-`MFI-`)/(2*`rSD-`)) %>%
...
Fig8e_new <- Phagocytosis_data %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Fig8e_new
ggsave(Fig8e_new,filename="New_Figures/Figure 8/Fig8e_new.png",
       width = 18,height = 15,dpi = 300)
````

# MFI of Oxidation
Fig8f_new <- Phagocytosis_data %>%
  dplyr::filter(Time=="45min",
                #Visit=="Week 1",
                Stimulant=="LPS") %>%
  dplyr::mutate(Oxidation_SI = (`MFI+`-`MFI-`)/(2*`rSD-`)) %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Fig8f_new
ggsave(Fig8f_new,filename="New_Figures/Figure 8/Fig8f_new.png",
       width = 18,height = 15,dpi = 300)
````


# ggsave 
ggsave(filename = "New_Figures/Figure 8/Fig8.png",
       plot = ((Fig8a_new|Fig8b_new|plot_layout(ncol = 2,nrow = 1, width = c(1,1))))/ 
         (Fig8c_new|Fig8d_new|plot_layout(width = c(1,1)))/
         (Fig8e_new|Fig8f_new|plot_layout(width = c(1,1))),
       width = 32, height = 31, units = "in", dpi = 300)

ggsave(filename = "New_Figures/Reviewers_Comments/Figure 8/Fig8.pdf",
       plot = ((Fig8a_new|Fig8b_new|plot_layout(ncol = 2,nrow = 1, width = c(1,1))))/ 
         (Fig8c_new|Fig8d_new|plot_layout(width = c(1,1)))/
         (Fig8e_new|Fig8f_new|plot_layout(width = c(1,1))),
       width = 32, height = 31, units = "in", dpi = 300)
...
Extended_Fig8a <- Masterfile %>%
  ...
  labs(x="Carriage Density (CFU/ML)",
       title = "d.",
       y=expression("Neutrophil to epithelial cell ratio (log10)"))+
  theme_classic2()+
  theme(legend.position = 'none',
        legend.background = element_rect(color='white'),
        legend.title = element_text(size=30,face = 'bold'),
...
ggsave(Extended_Fig8a,filename="New_Figures/Extended_Figure 8/Extended_Fig8a.png",
       width = 15,height = 10,dpi = 300,units = "in")
````
Masterfile %>%
  filter(`Epithelial count`>500,
         ...
         Visit %in% c("Week 1","Week 2","Week 3","Week 4", "Week 5"),
         `HIV Status`!="NA",
         `Neutrophil CD11b++`>25 & `Neutrophil CD11b++`<90,
         #`Carriage Status`=="Carriage Positive",
         `CD11b Staining`=="Stained") %>%
  ggplot(aes(x=factor(`Carriage Status`,levels=c('Carriage Negative','Carriage Positive')),
...
Masterfile %>%
  ...
  labs(x='',
       title = 'a.',
       y='Neutrophil to epithelial Ratio',
       fill='HIV Status')+
  theme_classic2()+
  theme(legend.position = 'none',
        legend.background = element_rect(color='white'),
...
Phagocytosis_data <- Phagocytosis_data %>%
  merge(Micro, by = "LAB ID", all=F)

write_csv(Phagocytosis_data, "Data/Main_Files_Thesis/Neutrophil_Phagocytosis.csv")
````
Phagocytosis_data <- read_csv("Data/Main_Files_Thesis/Neutrophil_Phagocytosis.csv")
# Neutrophil Phagocytosis and oxidation
# Frequency of Phagoctyosis
Fig10a <- Phagocytosis_data %>%
  dplyr::filter(Time=="45min",
                #Visit=="Week 1",
                Stimulant=="LPS") %>%
  ggplot(aes(x=factor(`HIV Status`,
                      levels=c('HIV-','PLHIV ART <3m', 'PLHIV ART >1y')),
             y=`Proportion of Phagocytosis`,
             color=factor(`HIV Status`,
                          levels=c('HIV-','PLHIV ART <3m', 'PLHIV ART >1y'))))+
  geom_boxplot(width=0.5,notch = F, outlier.shape = NA)+
  geom_jitter(position = position_jitter(width = 0.2),size=7) +
...
````
# MFI of Phagocytosis
Fig10b <- Phagocytosis_data %>%
  dplyr::filter(Time=="45min",
                #Visit=="Week 1",
                Stimulant=="LPS") %>%
  ggplot(aes(x=factor(`HIV Status`,
                      levels=c('HIV-','PLHIV ART <3m', 'PLHIV ART >1y')),
             y=log10(`MFI phagocytosis`),
             color=factor(`HIV Status`,
                          levels=c('HIV-','PLHIV ART <3m', 'PLHIV ART >1y'))))+
  geom_boxplot(width=0.5,notch = F, outlier.shape = NA)+
  geom_jitter(position = position_jitter(width = 0.2),size=7) +
  ...
  scale_color_manual(values = c('#A9A9A9','#941100','#005493'))+
  labs(x='',
       y="MFI Phagocytosis (Log10)",
       #fill='HIV Status',
       title = "b.")+
  scale_x_discrete(labels=c("HIV-"="HIV-",
                            "PLHIV ART <3m"="PLHIV\nART<3m",
                            "PLHIV ART >1y"="PLHIV\nART>1yr"))+
  scale_y_continuous(breaks = c(4,4.2,4.4,4.6,4.8,5))+
  theme_classic()+
  theme(legend.position = 'none',
        legend.background = element_rect(color='white'),
        legend.title = element_text(size=30,face = 'bold'),
...
````
# MFI of Phagocytosis
Fig10c <- Phagocytosis_data %>%
  dplyr::filter(Time=="45min",
                #Visit=="Week 1",
                Stimulant=="LPS") %>%
  ggplot(aes(x=factor(`HIV Status`,
                      levels=c('HIV-','PLHIV ART <3m', 'PLHIV ART >1y')),
             y=`Reporter out of Phagocytosed`,
             color=factor(`HIV Status`,
                          levels=c('HIV-','PLHIV ART <3m', 'PLHIV ART >1y'))))+
  geom_boxplot(width=0.5,notch = F, outlier.shape = NA)+
  geom_jitter(position = position_jitter(width = 0.2),size=7) +
  ...
  scale_x_discrete(labels=c("HIV-"="HIV-",
                            "PLHIV ART <3m"="PLHIV\nART<3m",
                            "PLHIV ART >1y"="PLHIV\nART>1yr"))+
  scale_y_continuous(breaks = c(60,80,100,120),limits = c(60,120))+
  theme_classic()+
  theme(legend.position = 'none',
        legend.background = element_rect(color='white'),
        legend.title = element_text(size=30,face = 'bold'),
...
Fig10d
````
# Frequency of Oxidation
Fig10e <- Phagocytosis_data %>%
  dplyr::filter(Time=="45min",
                #Visit=="Week 1",
                Stimulant=="LPS") %>%
  dplyr::mutate(Oxidation_SI = (`MFI+`-`MFI-`)/(2*`rSD-`)) %>%
...
ggsave(Fig10i,filename="New_Figures/Figure 10/Fig10i.png",
       width = 14,height = 18,dpi = 300)

````

# MFI of Oxidation
Fig10j <- Phagocytosis_data %>%
  dplyr::filter(Time=="45min",
                #Visit=="Week 1",
                Stimulant=="LPS") %>%
  dplyr::mutate(Oxidation_SI = (`MFI+`-`MFI-`)/(2*`rSD-`)) %>%
  ...
  labs(x='',
       ...
       #fill='HIV Status',
       title = "b."#,
       #subtitle = "Frequency of Phagocytosis * Phagocytosis MFI"
  )+
  facet_wrap(~`HIV Status`)+
  scale_x_discrete(labels=c("Carriage Negative"="Carriage\nNegative",
                            "Carriage Positive"="Carriage\nPositive"))+
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Fig10j
ggsave(Fig10j,filename="New_Figures/Figure 10/Fig10j.png",
       width = 18,height = 15,dpi = 300)
````

# MFI of Oxidation
Fig10k <- Phagocytosis_data %>%
  dplyr::filter(Time=="45min",
                #Visit=="Week 1",
                Stimulant=="LPS") %>%
  dplyr::mutate(Oxidation_SI = (`MFI+`-`MFI-`)/(2*`rSD-`)) %>%
...
ggsave(Fig10k,filename="New_Figures/Figure 10/Fig10k.png",
       width = 14,height = 18,dpi = 300)

````

# MFI of Oxidation
Fig10l <- Phagocytosis_data %>%
  dplyr::filter(Time=="45min",
                #Visit=="Week 1",
                Stimulant=="LPS") %>%
  dplyr::mutate(Oxidation_SI = (`MFI+`-`MFI-`)/(2*`rSD-`)) %>%
  ...
  theme(legend.position = 'none',
        ...
        axis.title = element_text(size = 30))
Fig10l
ggsave(Fig10l,filename="New_Figures/Figure 10/Fig10l.png",
       width = 18,height = 15,dpi = 300)
````
Fig10m <- Phagocytosis_data %>%
  dplyr::filter(Time=="45min",
                Visit=="Week 1",
                `Carriage Status`=="Carriage Positive",
                Stimulant=="LPS") %>%
  dplyr::mutate(Oxidation_SI = (`MFI+`-`MFI-`)/(2*`rSD-`)) %>%
  dplyr::mutate(Product_Phagocytosis_MF1_Frequency = `MFI phagocytosis`*`Proportion of Phagocytosis`) %>%
  ggplot(aes(log10(Density), log10(Product_Phagocytosis_MF1_Frequency)#,color = `HIV Status`
  ))+
  geom_point(aes(color=`HIV Status`),size=7)+
  geom_smooth(method = "lm",se=T)+
  stat_cor(method = "spearman", size=10)+
  #facet_wrap(~`HIV Status`)+
  scale_color_manual(values = c('#A9A9A9','#941100','#005493'))+
  labs(x='Log10 Carriage Density (CFU/ML)',
       y="Phagocytosis Index (Log10)",
       #fill='HIV Status',
       title = "e."
  )+
...
Fig10n <- Phagocytosis_data %>%
  ...
  dplyr::mutate(Oxidation_SI = (`MFI+`-`MFI-`)/(2*`rSD-`)) %>%
  dplyr::mutate(Product_Oxidation_MF1_Frequency = Oxidation_SI*`Reporter out of Phagocytosed`) %>%
  ggplot(aes(log10(Density), log10(Product_Oxidation_MF1_Frequency)#,color = `HIV Status`
  ))+
  geom_point(aes(color=`HIV Status`),size=7)+
  geom_smooth(method = "lm",se=T)+
  stat_cor(method = "spearman", size=10)+
...
ggsave(filename = "New_Figures/Figure 10/Fig10_New.pdf",
       plot = ((Fig10i|Fig10j|plot_layout(ncol = 2,nrow = 1, width = c(1,2))))/ 
         (Fig10k|Fig10l|plot_layout(width = c(1,2)))/
         (plot_spacer()|plot_layout(width = c(1,1,1,1))),
       width = 38, height = 36, units = "in", dpi = 300)

ggsave(filename = "New_Figures/Figure 10/Fig10_New.png",
       plot = ((Fig10i|Fig10j|plot_layout(ncol = 2,nrow = 1, width = c(1,2))))/ 
         (Fig10k|Fig10l|plot_layout(width = c(1,2)))/
         (plot_spacer()|plot_layout(width = c(1,1,1,1))),
       width = 38, height = 36, units = "in", dpi = 300)
...
# ggsave ----
ggsave(filename = "New_Figures/Figure 10/Fig10.pdf",
       plot = ((Fig10a|Fig10b|Fig10c|Fig10d|plot_layout(ncol = 4,nrow = 1, width = c(1,1,1,1))))/ 
         (Fig10e|Fig10f|plot_layout(width = c(1,1)))/
         (Fig10g|Fig10h|plot_layout(width = c(1,1))),
       width = 32, height = 29, units = "in", dpi = 300)

ggsave(filename = "New_Figures/Figure 10/Fig10.png",
       plot = ((Fig10a|Fig10b|Fig10c|Fig10d|plot_layout(ncol = 4,nrow = 1, width = c(1,1,1,1))))/ 
         (Fig10e|Fig10f|plot_layout(width = c(1,1)))/
         (Fig10g|Fig10h|plot_layout(width = c(1,1))),
       width = 32, height = 29, units = "in", dpi = 300)
...
Phagocytosis_data %>%
  dplyr::filter(Time=="45min",
                #Visit=="Week 1",
                Stimulant=="LPS") %>%
  dplyr::select(`HIV Status`,
                `Carriage Status`) %>%
  dplyr::group_by(`Carriage Status`,`HIV Status`) %>%
  count()
...
# Read immune cells ----
Immune_cells <- readRDS("Data/Single_Cell_data/Immune_cells.rds")
view(Immune_cells@meta.data)
view(all_merged_subset_labelled_new@meta.data)

all_merged_subset_labelled_new <- AddModuleScore(
  object = all_merged_subset_labelled_new,
  features = module_features,
  name = names(module_features),  # Names will be appended with numbers (e.g., "Glycan_biosynthesis1")
  slot = "data"
)

Fig8b_new <- Immune_cells@meta.data %>%
  dplyr::filter(Clusters %in% c("Neutrophils")) %>%
  ggplot(aes(Carriage_Status, SASP2, fill=Carriage_Status))+
  geom_violin(scale = 'width',trim = T)+
  #geom_boxplot(width=0.1,notch = T, outlier.shape = NA, fill='white')+
  stat_summary(geom = "point",
               fun = median,
  ...
  labs(x='',
       title = 'b.',
       y='SASP Module Expression',
       fill='Carriage_Status')+
  scale_x_discrete(labels=c("SPN-"="Carriage\nNegative",
                            "SPN+"="Carriage\nPositive"))+
  facet_wrap(~ `HIV_Status`,
             labeller = labeller(`HIV_Status` = c("HIV-" = "HIV-",
                                                  "HIV+ ART<3 Months" = "PLHIV-ART<3m",
                                                  "HIV+ ART>1 Year" = "PLHIV-ART>yr")))+
  theme_classic2()+
  theme(legend.position = 'none',
        legend.background = element_rect(color='white'),
        legend.title = element_text(size=30,face = 'bold'),
...
# Save figure 8 ggsave
ggsave(filename = "New_Figures/Figure 8/Fig8_new.png",
       plot =((Fig8a_new|Fig8b_new|plot_layout(ncol = 2,nrow = 1, width = c(2.8))))/ 
         (plot_spacer()|plot_layout(width = c(1)))/
         (plot_spacer()|plot_layout(width = c(1))),
       width = 32, height = 29, units = "in", dpi = 300)

ggsave(filename = "New_Figures/Figure 8/Fig8_new.pdf",
       plot =((Fig8a_new|Fig8b_new|plot_layout(ncol = 2,nrow = 1, width = c(2.8))))/ 
         (plot_spacer()|plot_layout(width = c(1)))/
         (plot_spacer()|plot_layout(width = c(1))),
       width = 32, height = 29, units = "in", dpi = 300)
...
# Neutrophil subsets ----
Masterfile %>%
  dplyr::filter(`CD11b Staining`=="Stained",
                `CD45+ count`>200,
                #`Visit`=="Week 1",
                `HIV Status`!="NA",
                `Epithelial count`>250) %>%
  ggplot(aes(`HIV Status`,`Neutrophil CD62L proportion`))+
  geom_boxplot()+
  geom_pwc()+
  geom_jitter(width = 0.2)+
  #facet_wrap(~`Carriage Status`)+
...
HIV_Paper_Masterfile <- Masterfile %>%
  dplyr::select(`LAB ID`,PID,Visit, `HIV Status`,`Carriage Status`, Density,`CD11b Staining`, `CD3 Staining`, `CD45+ count`,`Epithelial count`,
                NER, MER, `CD4+`, `CD8+`, `CD3+Mait`,`CD3+TCRgd+`, `CD3+CD56+`, `Myeloperoxidase (pg/mL)`, `Neutrophil CD11b++`) %>%
  dplyr::filter(`CD45+ count`>200,
                `Epithelial count`>500,
                `HIV Status`!="NA",
                Visit=="Week 1")
